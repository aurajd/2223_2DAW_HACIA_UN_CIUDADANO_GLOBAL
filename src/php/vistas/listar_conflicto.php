...
<head>
    ...
    <title>Lista conflictos</title>
    <link rel="stylesheet" href="css/style_admin.css">
</head>
<body>
    <nav class="navbar">
        <h1>Listar conflictos</h1>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    ...
                                    <li><a href='index.php?controller=problema&action=listar_motivo&id=<?php echo $fila['idSituacion'] ?>'>Listar motivos</a></li>
                                </ul>
                            </td>
                        </tr>
                        <?php
